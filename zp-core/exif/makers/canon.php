	...
	if ($type == "ASCII") {
		...
		if ($tag == "0001") { //first chunk
			...
			if ($result['AFPointUsed'] & 0x0001) {
				$afPointUsed[] = gettext("Right"); //bit 0
			}
			if ($result['AFPointUsed'] & 0x0002) {
				$afPointUsed[] = gettext("Center"); //bit 1
			}
			if ($result['AFPointUsed'] & 0x0004) {
				$afPointUsed[] = gettext("Left"); //bit 2
			}
			if ($result['AFPointUsed'] & 0x0800) {
				$afPointUsed[] = gettext("12"); //bit 12
			}
			if ($result['AFPointUsed'] & 0x1000) {
				$afPointUsed[] = gettext("13"); //bit 13
			}
			if ($result['AFPointUsed'] & 0x2000) {
				$afPointUsed[] = gettext("14"); //bit 14
			}
			if ($result['AFPointUsed'] & 0x4000) {
				$afPointUsed[] = gettext("15"); //bit 15
			}
 ...
 * Useful:
 *
 * - https://www.burren.cx/david/canon.html
 * - https://www.burren.cx/david/canon.html
