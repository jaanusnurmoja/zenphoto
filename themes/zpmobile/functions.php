...
function jqm_printFooterNav() {
	...
	<div id="footer" data-role="footer">
		...
		?>
		<ul id="footerlist">
			<li><?php echo gettext('Powered by'); ?> <a href="https://www.zenphoto.org">Zenphoto</a> and <a href="https://jquerymobile.com">jQueryMobile</a></li>
			<li><?php echo gettext('zpMobile theme by'); ?> <a href="https://www.maltem.de">Malte Müller</a></li>
		</ul>
		<?php
		$adminlink = '';
		$favoriteslink = '';
